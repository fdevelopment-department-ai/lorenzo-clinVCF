...
* **`styles/`** : Dossier contenant les feuilles de style. Elle gére les variables de design (couleurs, polices Inter, thèmes) et gère l'affichage responsive et moderne du site.
